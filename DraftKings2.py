                ...
                for TwoB in secondbase:
                    ...
                    for SS in shortstops:
                        ...
                        for ThreeB in thirdbase:
                            if ThreeB not in team:
                                team[6] = ThreeB
                            else:
                                continue
                            for OF1 in range(0, numOF - 2):
                                if outfield[OF1] not in team:
                                    team[7] = outfield[OF1]
                                else:
                                    continue
                                for OF2 in range(OF1 + 1, numOF - 1):
                                    if outfield[OF2] not in team:
                                        team[8] = outfield[OF2]
                                    else:
                                        continue
                                    for OF3 in range(OF2 + 1, numOF):
                                        if outfield[OF3] not in team:
                                            team[9] = outfield[OF3]
                                        else:
                                            continue
                                        ...
                                        if totalSalary <= MAX_SALARY and totalScore > maxScore * 0.99:
